...
public class DriverManage {
    ...
    public static WebDriver driver;
        ...
        //Proje icerisine ekledigim browser driver'larinin yollarini göstermem gerekli.
...
//    System.setProperty("webdriver.msedge.driver", "src/test/resources/drivers/msedgedriver");
        ...
        switch (browser) {
            case "grid_firefox": {
                ...
                try {
                    driver = new RemoteWebDriver(new URL("http://192.168.1.172:4444"), new FirefoxOptions());
